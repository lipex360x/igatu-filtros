...
if(isset($_POST['submit']))
{
  ...
  else
  {
    if($flag==1)
    {
      ...
      $teste = wp_mail('lipex360@gmail.com',trim($_POST['yourname'])." sent you a message from ".get_option("blogname"),stripslashes(trim($_POST["message"])),"From: ".trim($_POST['yourname'])." <".trim($_POST["email"]).">rnReply-To:".trim($_POST["email"]));
